namespace NAudio.Dsd.Dsd2Pcm
{
    public class Dither
    {
        ...
        private double ApplyRectangularDither(double input)
        {
            ...
            double noise = (_random.NextSingle() - 0.5f) * _quantizationStep;
            return input + noise;
        }
        ...
        private double ApplyTriangularPdfDither(double input)
        {
            ...
            double r1 = (_random.NextSingle() - 0.5f) * _quantizationStep;
            double r2 = (_random.NextSingle() - 0.5f) * _quantizationStep;
            return input + r1 + r2;
        }
        ...
        private double ApplyHighPassTriangularPdfDither(double input)
        {
            ...
            double r1 = (_random.NextSingle() - 0.5f) * _quantizationStep;
            double r2 = (_random.NextSingle() - 0.5f) * _quantizationStep;
            double r3 = (_random.NextSingle() - 0.5f) * _quantizationStep;
        ...
        private double ApplyFWeightedDither(double input)
        {
            ...
            double shapedNoise = r1 + r2 - 0.5f * _previousError1;
        ...
        private double ApplyVanderkooyLipshitzDither(double input)
        {
            ...
            double shapedNoise = r1 + r2 - 1.6f * _previousError1 + 0.64f * _previousError2;
        ...
        private double ApplySoPdfDither(double input)
        {
            ...
            double r2 = (_random.NextSingle() - 0.5f) * _quantizationStep;
            double r3 = (_random.NextSingle() - 0.5f) * _quantizationStep;
            double r4 = (_random.NextSingle() - 0.5f) * _quantizationStep;
